...
PAISES_OPERADORES = {
    ...
    "GRSA": "Grecia / Arabia Saudita (missao conjunta)",
    "AC": "AsiaSat (operador comercial)",
    "THAI": "Tailandia",
    "MEX": "Mexico",
    "KAZ": "Cazaquistao",
    "ABS": "Asia Broadcast Satellite (operador comercial)",
    "PAKI": "Paquistao",
    "MALA": "Malasia",
    "VTNM": "Vietname",
    "EGYP": "Egito",
    ...
    "SAUD": "Arabia Saudita",
    "ALG": "Argelia",
    "TMMC": "Turquemenistao / Monaco (missao conjunta)",
    "SWED": "Suecia",
    "SVN": "Eslovenia",
    "STCT": "Singapura / Taiwan (missao conjunta)",
    "RP": "Filipinas",
    "RASC": "RascomStar-QAF (operador comercial)",
    "NIG": "Nigeria",
    "LAOS": "Laos",
    "FRIT": "Franca / Italia (missao conjunta)",
    "BUL": "Bulgaria",
    "BOL": "Bolivia",
    "BGD": "Bangladesh",
    "BELA": "Bielorrussia",
